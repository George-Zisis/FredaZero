...
class Game:
	...
	def valid_to_all_actions(self, state, actions):
		bin_board = self.get_bin_actions(state)
		count = 0
		for idx, move in enumerate(bin_board):
			bin_board[idx] = actions[count] if move == 1 else 0
